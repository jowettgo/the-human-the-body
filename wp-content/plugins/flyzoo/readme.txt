=== Chat by Flyzoo ===
Contributors: Flyzoo
Tags: chat buddypress, buddypress, chat, group chat, community chat, live chat, buddypress chat, live support chat, embed chat, chat room, chatroom, ultimate member, chat members, support chat, bbpress, chat widget, chat plugin, social network, community
...
The perfect chat for your community with chat rooms, private chats and much more... Great for BuddyPress and Ultimate Member.
...
Designed for dating websites, forums, webinars, social networks, online traders, gamers, radio stations, events... and any other kind of site looking to connect users and boost engagement.
...
* **Cloud based chat**: no server load. Enjoy a fast message delivery without using your server's resources

* **Single Sign On**: members can login and chat with their existing accounts!

* **Friends & Profile Sync:** user names, avatars and friends are automatically synchronized with the chat
...
* **Role-based access:** retrict access to group chats depending on user role (i.e. paid, pro...), designed for sites with paid membership levels (JUMBO+ Plan)

* **In-browser chat experience**: browse the site and chat at the same time, resize or minimize windows when needed
...
* **Real-time visitors monitoring**: identify and chat with potential customers ro increase sales! (PRO+ Plan)
...
[Flyzoo Chat - Customer Support >>](http://www.flyzoo.co/support)
